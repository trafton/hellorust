...
use crate::{CombatStats, Consumable, InBackpack, Name, Position, ProvidesHealing, WantsToUseItem, WantsToDropItem, WantsToPickupItem, InflictsDamage, Map, SufferDamage, AreaOfEffect, Confusion, Equippable, Equipped};
use specs::prelude::*;
