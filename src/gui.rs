...
pub fn main_menu(gs : &mut State, ctx : &mut Rltk) -> MainMenuResult {
    ...
    ctx.print_color_centered(20, RGB::named(rltk::YELLOW), RGB::named(rltk::BLACK), "Rust Rouge");
    ctx.print_color_centered(21, RGB::named(rltk::CYAN), RGB::named(rltk::BLACK), "Inspired by Herbert Wolverson");
